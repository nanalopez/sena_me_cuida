...
class IngresoVisitantes extends Component {
    ...
    async componentDidMount() {
        ...
        await fetch(`${process.env.REACT_APP_API_URL}/api/estadoVisitante/countIngMeses`)
            .then(res => res.json())
            .then(data => {
        ...
        return (
            <Line
                data={this.state.chartData = {
                    ...
                    datasets: [
                        {
                            label: 'Visitantes ingresos por Mes',
                ...
                options={{
                    ...
                    title: {
                        display: true,
                        text: "Estadísticas de ingreso de visitantes por mes",
                    }
                }}>
