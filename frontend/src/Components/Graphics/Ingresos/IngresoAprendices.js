...
class IngresoAprendices extends Component {
    ...
    async componentDidMount() {
        ...
        await fetch(`${process.env.REACT_APP_API_URL}/api/estadoAprendiz/countIngMeses`)
            .then(res => res.json())
            .then(data => {
        ...
        return (
            <Line
                data={this.state.chartData = {
                    ...
                    datasets: [
                        {
                            label: 'Aprendices ingresos por Mes',
                ...
                options={{
                    ...
                    title: {
                        display: true,
                        text: "Estadísticas de ingreso de aprendices por mes",
                    }
                }}>
...
export default IngresoAprendices
